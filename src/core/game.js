...
import { renderScene } from "../render/scene.js?v=20260924-phone-bin-labels-1";
import { getBeltTravelRate, setBeltTravelRate } from "../render/conveyor.js?v=20260923-seamless-1";
import { renderGameUi } from "../ui/game-ui.js?v=20260925-clear-food-bg-1";
...
import { preloadLevelAssets } from "../data/assets.js?v=20260925-clear-food-bg-1";
...
export function createGame({ persistProgress = true, gameId = "Food-for-Health" } = {}) {
