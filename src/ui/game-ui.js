...
export function renderGameUi(state, level) {
  ...
  if (state.screen === "complete") {
    ...
    screen.setAttribute("aria-label", "Food for Health Master certificate");
    ...
    card.innerHTML = `
      ...
      <p class="game-certificate__eyebrow">Healthy Food Champion</p>
      <h2>Food Group <em>Master!</em></h2>
      ...
      <div class="game-certificate__stamps" aria-label="Skills mastered">
        <div class="game-certificate__stamp game-certificate__stamp--shapes"><i aria-hidden="true">🍚</i><strong>Energy</strong></div>
        <div class="game-certificate__stamp game-certificate__stamp--families"><i aria-hidden="true">🥛</i><strong>Building</strong></div>
        <div class="game-certificate__stamp game-certificate__stamp--motion"><i aria-hidden="true">🥕</i><strong>Protective</strong></div>
      </div>
  ...
  if (state.completedLevel) {
    ...
    success.innerHTML = `
      <img class="success-screen__background" src="assets/backgrounds/bg.webp?v=20260925-clear-food-bg-1" alt="" />
  ...
  if (state.paused) {
    ...
    pause.innerHTML = `
      <img class="pause-screen__background" src="assets/backgrounds/bg.webp?v=20260925-clear-food-bg-1" alt="" />
